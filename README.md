...
**Источник:** [Avito Demand Prediction Challenge](https://www.kaggle.com/competitions/avito-demand-prediction)
...
Скачайте датасет RetailRocket с Kaggle

Разместите файлы в папке for_retail/archive/

Запустите подготовку: python prepare_retailrocket.py

Обучите модели: python train_models.py

Проведите сравнение: python evaluate_and_recommend.py
